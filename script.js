...
const targetDate = new Date("2026-04-04T20:30:00").getTime();
...
document.getElementById("mapaModal").addEventListener("click", function(e) {
  if (e.target === this) {
    cerrarMapa();
  }
});
...
function abrirAlbum() {
  document.getElementById("albumModal").classList.add("activo");
  document.body.style.overflow = "hidden";
}

function cerrarAlbum() {
  document.getElementById("albumModal").classList.remove("activo");
  document.body.style.overflow = "auto";
}

function abrirRegalo() {
  document.getElementById("regaloModal").classList.add("activo");
}

function cerrarRegalo() {
  document.getElementById("regaloModal").classList.remove("activo");
}

function abrirHospedaje() {
  document.getElementById("hospedajeModal").classList.add("activo");
  document.body.style.overflow = "hidden";
}

function cerrarHospedaje() {
  document.getElementById("hospedajeModal").classList.remove("activo");
  document.body.style.overflow = "auto";
}
